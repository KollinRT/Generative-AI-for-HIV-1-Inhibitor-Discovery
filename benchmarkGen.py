...
if __name__ == "__main__":
    ...
    # print(type(num_samples_to_have))
    ...
    # mol_sizes = [10,25,50,100,1_000,10_000,100_000,1_000_000,10_000_000]
    mol_sizes = [50,100,1_000,10_000,100_000,1_000_000,10_000_000]
    # for mol_size in mol_sizes:
    #     num_samples = mol_size / batch_size
    #     gen_dir = os.path.join(benchmark_dir, f"{mol_size}x{batch_size}x{num_samples}")
    ...
    gen = HuggingFaceMoleculeGenerator(
        model_path="./runs/made_a_good_ring_selfeiesbartptmodel4warmup/model",
    ...
    #     gen, finetune_smiles, pretrain_smiles, num_samples=num_samples, batch_size=batch_size, num_workers=12,
    #     output_csv=output_csv
    # )

    # benchmark_results = benchmark_generated_molecules_smiles(
    #     gen, finetune_smiles, pretrain_smiles, batch_size=batch_size,
    #     output_csv=output_csv
    # )

    # TODO: 07/19/2025 Think to add SELFIES and PARQUET support?
    # benchmark_results = benchmark_generated_molecules_smiles(
