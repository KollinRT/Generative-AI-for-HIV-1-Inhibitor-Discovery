# from bart_model import SelfiesTokenizer
# from transformers import BartForConditionalGeneration, BartConfig
# import pandas as pd
# from tokenizers import Tokenizer
# from bart_model import SelfiesDataset
...
#
#
#     dataset = SelfiesDataset(selfies_path, tokenizer)
#     data_loader = DataLoader(dataset, batch_size=TRAIN_BATCH_SIZE, shuffle=True)
#
#     # TODO: or is this the below one?
#     # tokenizer = SelfiesTokenizer(bpe_path+"/bpe.json") # TODO: GOT TO GET BPE SETUP RIGHT ON HERE...
...
#     MAX_LEN = hyperparameters_dict["MAX_LEN"]
#
#     tokenizer = Tokenizer.from_file(f"{bpe_path}/bpe.json")
#
#     config = BartConfig(
...
#         return BartForConditionalGeneration(config=config)
#
#     dataset = SelfiesDataset(selfies_path, f"{bpe_path}/bpe.json", max_len=MAX_LEN)
